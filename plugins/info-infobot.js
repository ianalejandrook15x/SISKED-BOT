...
await conn.reply(m.chat, sisked, fkontak, { contextInfo: { mentionedJid: [owner[0][0] + '@s.whatsapp.net'], externalAdReply: { mediaUrl: false, mediaType: 1, description: false, title: '↷✦╎Info - Bot╎⭐˖ ⸙',body: packname, previewType: 0, thumbnail: icons, sourceUrl: redes}}})
